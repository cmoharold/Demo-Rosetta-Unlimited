...
insert into porta_orders (portab_request_id,directory_number_id,portab_doc_id,portab_type_des,donor_operator_des,receiving_operator_des,portab_order_date) values (778,'600000005','57453454P','DIFERIDA','MOVISTAR','ORANGE','2019-06-17 0:00:00');
insert into porta_orders (portab_request_id,directory_number_id,portab_doc_id,portab_type_des,donor_operator_des,receiving_operator_des,portab_order_date) values (112,'600000007','32453434C','DIFERIDA','VODAFONE','ORANGE','2020-12-17 0:00:00');
insert into porta_orders (portab_request_id,directory_number_id,portab_doc_id,portab_type_des,donor_operator_des,receiving_operator_des,portab_order_date) values (887,'600000009','12334555T','DIFERIDA','VODAFONE','ORANGE','2015-02-09 0:00:00');
...
--update client
insert into scoring (scr_id,document_id,riesgo,scr_date) values (8945655,'10000000W','MEDIO','2018-12-17 0:00:00');
...
values (897,'600000018','10000000W','DIFERIDA','VODAFONE','ORANGE','2019-12-17 0:00:00');
